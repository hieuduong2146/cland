    ...
    pageEncoding="UTF-8"%>
		  ...
		  <div class="col-md-2">
		  	<div class="sidebar content-box" style="display: block;">
				...
				<ul class="nav">
				    <!-- Main menu -->
				    <li class="current"><a href="index.html"><i class="glyphicon glyphicon-home"></i> Trang chủ</a></li>
				    ...
				    <li><a href="${pageContext.request.contextPath }/admin/user/index"><i class="glyphicon glyphicon-plus"></i>Người dùng</a></li>
				    <li class="submenu">
				         <a href="#">
